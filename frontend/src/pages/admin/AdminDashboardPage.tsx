      ...
      <aside className="w-full md:w-64 bg-white border-r border-slate-200 flex flex-col justify-between shrink-0">
        ...
        <div>
          ...
          <nav className="p-3 space-y-1">
            ...
            >
              ...
              <span>User Moderation & Access</span>
            </button>
          </nav>
        </div>
        ...
        <div className="p-4 border-t border-slate-100 space-y-3">
          ...
          <div className="p-3 rounded-xl bg-slate-50 border border-slate-200">
            ...
            <button
              onClick={() => logout()}
              className="mt-2.5 w-full flex items-center justify-center gap-1.5 py-1.5 text-xs font-bold text-rose-600 hover:bg-rose-50 rounded-lg transition-colors cursor-pointer"
            >
